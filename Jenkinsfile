...
rocHPCGCI:
{
    ...
    def nodes = new dockerNodes(['gfx906 && ubuntu', 'gfx906 && centos7', 'gfx908 && centos7'], rochpcg)
    ...
    def testCommand =
    {
        ...
        def command = """#!/usr/bin/env bash
                        ...
                        ${sudo} LD_LIBRARY_PATH=/opt/rocm/hcc/lib ./rochpcg-test --gtest_output=xml --gtest_color=yes
                    """
