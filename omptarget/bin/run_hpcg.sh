...
echo "================================================================="
echo $MPI/bin/mpirun -np 1 --mca btl_openib_warn_no_device_params_found 0 $AOMP/bin/gpurun $HPCG_BIN_DIR/xhpcg
$MPI/bin/mpirun -np 1 --mca btl_openib_warn_no_device_params_found 0 $AOMP/bin/gpurun $HPCG_BIN_DIR/xhpcg
